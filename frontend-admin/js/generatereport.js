...
class ReportsPage {
    ...
    getCurrentAustralianFY() {
        ...
        console.log('??? Calculated Australian FY year:', fyYear);
        return fyYear;
    }
    ...
    getCurrentAustralianQuarter() {
        ...
        console.log('??? Current Australian quarter:', quarter, 'for month:', currentMonth);
        return quarter;
    }
    ...
    openGenerateModalWithDefaults() {
        ...
        // Initialize the modal with current defaults
        this.initializeReportModal(currentFY, currentQuarter);
    }

    initializeReportModal(defaultYear, defaultQuarter) {
        // Populate year dropdown
        this.populateYearDropdown(defaultYear);
        
        // Set default values
        document.getElementById('report-type').value = 'quarterly';
        document.getElementById('report-year').value = defaultYear;
        document.getElementById('report-quarter').value = defaultQuarter;
        
        // Show/hide quarter selection based on type
    ...
    populateYearDropdown(defaultYear) {
    ...
    updatePeriodDisplay() {
        ...
        if (reportType === 'quarterly') {
            ...
            modalPeriod.textContent = `${quarterNames[quarter]} FY ${financialYear}`;
        } else {
            modalPeriod.textContent = `Annual FY ${financialYear}`;
        }
        
        // Store current selection
        this.selectedReportSlot = { 
            type: reportType, 
            year: year, 
            quarter: quarter, 
    ...
    async generateReportFromModal() {
        ...
        if (reportType === 'quarterly' && (!quarter || isNaN(quarter))) {
        ...
        try {
            ...
            console.log(`?? Generating ${reportType} report for ${period} (Australian FY: ${financialYear}, quarter: ${quarter})`);
            ...
            if (!this.currentReport.type && reportType) {
            ...
            this.reportHistory.unshift({
                ...
                type: reportType, // Ensure type is preserved
        ...
        if (nonCashSummaryEl && report.contributionBreakdown) {
            ...
            nonCashSummaryEl.innerHTML = `
                <div style="background: #f8f9fa; padding: 15px; border-radius: 8px; margin-top: 15px;">
                    ...
                    <p style="margin: 5px 0;"><strong>In-Kind Donations Received:</strong> $${(breakdown.totalInKindIncome || 0).toFixed(2)} (${breakdown.nonCashContributionsCount || 0} items)</p>
                    ...
                    <div class="report-sections">
                        ...
                        <div class="report-section full-width">
                            ...
                            <table class="report-table">
                                ...
                                <tr>
                                    <td>+ Current Period Cash Income</td>
                                    <td>+$${((report.contributionBreakdown && report.contributionBreakdown.totalCashIncome) || 0).toFixed(2)}</td>
                                </tr>
                                <tr>
                                    <td>- Current Period Cash Expenses</td>
                                    <td>-$${((report.contributionBreakdown && report.contributionBreakdown.totalCashExpenses) || 0).toFixed(2)}</td>
                                </tr>
                                <tr class="total-row">
                    ...
                    <div class="report-sections">
                        <div class="report-section full-width">
                            ...
                            <table class="report-table">
                                ...
                                <tr>
                                    <td>+ Current Period Cash Net Movement</td>
                        ...
                        <div class="report-section full-width non-cash-section" style="margin-top: 40px; padding: 25px; background: #f8f9fa; border: 2px solid #dee2e6; border-radius: 8px;">
                            ...
                            <table class="report-table" style="max-width: 600px; margin: 0 auto;">
                                ...
                                <tr>
                                    <td style="padding: 12px;">Current Inventory Value (as at end of reporting period):</td>
...
renderOverlayIncomeWithBreakdown(tableId, categories, contributionBreakdown) {
        ...
        if (contributionBreakdown) {
            ...
            categoryRows += `
                <tr class="breakdown-separator">
                    <td colspan="2" style="border-top: 3px solid #27ae60; padding-top: 15px; padding-bottom: 10px; font-weight: bold; color: #27ae60; background: #f8f9fa; font-size: 14px;">
                        💵 CASH INCOME
                    </td>
                </tr>
            `;
            ...
            if (cashCategories.length > 0) {
                ...
                categoryRows += `<tr><td colspan="2" style="padding-left: 20px; font-style: italic; color: #999;">No cash income</td></tr>`;
            }
            
            categoryRows += `
                <tr style="background: #e8f5e9; font-weight: bold;">
                    <td style="padding-left: 20px;">TOTAL CASH</td>
            ...
            categoryRows += `
                <tr class="breakdown-separator">
                    <td colspan="2" style="border-top: 3px solid #3498db; padding-top: 15px; padding-bottom: 10px; font-weight: bold; color: #3498db; background: #f8f9fa; font-size: 14px;">
                        🎁 IN-KIND INCOME
                    </td>
                </tr>
            `;
            ...
            if (nonCashCategories.length > 0) {
                ...
                categoryRows += `<tr><td colspan="2" style="padding-left: 20px; font-style: italic; color: #999;">No in-kind income</td></tr>`;
            }
            
            categoryRows += `
                <tr style="background: #e3f2fd; font-weight: bold;">
                    <td style="padding-left: 20px;">TOTAL IN-KIND</td>
                    <td>${totalInKind.toFixed(2)}</td>
                </tr>
            `;
            ...
            if (categories && categories.length > 0) {
                ...
                categoryRows = '<tr><td colspan="2">No data available</td></tr>';
            }
        }
    ...
    renderOverlayCategoryTable(tableId, categories, contributionBreakdown) {
        const tbody = document.querySelector(`#${tableId}`);
        if (!tbody) return;
        ...
        if (contributionBreakdown) {
            const totalCash = contributionBreakdown.totalCashExpenses || 0;
            const totalInKind = contributionBreakdown.totalInKindExpense || 0;

            // 💵 CASH EXPENSES SECTION
            categoryRows += `
                <tr class="breakdown-separator">
                    <td colspan="2" style="border-top: 3px solid #e74c3c; padding-top: 15px; padding-bottom: 10px; font-weight: bold; color: #e74c3c; background: #f8f9fa; font-size: 14px;">
                        💵 CASH EXPENSES
                    </td>
                </tr>
            `;
            
            const cashCategories = contributionBreakdown.cashExpensesByCategory || [];
            if (cashCategories.length > 0) {
                categoryRows += cashCategories.map(cat => `
                    <tr>
                        <td style="padding-left: 20px;">${cat.category || 'Uncategorized'}</td>
                ...
                categoryRows += `<tr><td colspan="2" style="padding-left: 20px; font-style: italic; color: #999;">No cash expenses</td></tr>`;
            }
            ...
            // 🎁 IN-KIND EXPENSES SECTION
            categoryRows += `
                <tr class="breakdown-separator">
                    <td colspan="2" style="border-top: 3px solid #9b59b6; padding-top: 15px; padding-bottom: 10px; font-weight: bold; color: #9b59b6; background: #f8f9fa; font-size: 14px;">
                        🎁 IN-KIND EXPENSES
                    </td>
                </tr>
            `;
            
            const nonCashCategories = contributionBreakdown.nonCashExpensesByCategory || [];
            if (nonCashCategories.length > 0) {
                categoryRows += nonCashCategories.map(cat => `
                    <tr>
                        <td style="padding-left: 20px;">${cat.category || 'Uncategorized'}</td>
                ...
                categoryRows += `<tr><td colspan="2" style="padding-left: 20px; font-style: italic; color: #999;">No in-kind expenses</td></tr>`;
            }
    ...
    renderNonCashSectionContent(report) {
        const breakdown = report.contributionBreakdown || {};
        const totalNonCash = breakdown.totalInKindIncome || 0;
        ...
        return `
            ...
            <div style="background: white; padding: 20px; border-left: 4px solid #28a745; border-radius: 4px; margin-bottom: 20px;">
                <h5 style="color: #343a40; margin-bottom: 15px; font-size: 16px;">?? Current Inventory Status (as at end of reporting period):</h5>
                <p style="margin: 10px 0; color: #495057;">
    ...
    renderIncomeWithBreakdown(tableId, categories, contributionBreakdown) {
        ...
        if (contributionBreakdown) {
            ...
            console.log('?? Breakdown values:', { totalCash, totalInKind, cashCount, nonCashCount });
            ...
            if (totalCash > 0 || totalInKind > 0) {
                ...
                categoryRows += `
                    ...
                    <tr class="breakdown-row">
                        ...
                        <td style="color: #3498db;">$${totalInKind.toFixed(2)}</td>
                    </tr>
                    <tr style="background: #e8f5e9; font-weight: bold;">
                    ...
                    <tr style="background: #fff3cd;">
                        <td colspan="2" style="padding: 10px 20px; font-size: 12px; color: #856404; font-style: italic;">
                            ? <strong>Cash Flow Impact:</strong> Only the cash income affects your bank balance. In-kind donations are tracked for donor recognition and offset when consumed.
                        </td>
                    </tr>
                `;
