...
export default function BookPage() {
  ...
  if (loading) return (
    <div className="max-w-7xl mx-auto px-4 py-16 text-center text-gray-400">
      <p className="text-4xl mb-4 animate-pulse">📖</p><p>Loading...</p>
    </div>
  );
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Link href={`/books/${bookId}/reader`} className="group bg-white rounded-xl border-2 border-transparent hover:border-blue-500 p-6 hover:shadow-lg transition">
        ...
        <Link href={`/books/${bookId}/study`} className="group bg-white rounded-xl border-2 border-transparent hover:border-orange-500 p-6 hover:shadow-lg transition">
          <div className="text-5xl mb-4">🔀</div>
        ...
        <Link href={`/books/${bookId}/display`} className="group bg-white rounded-xl border-2 border-transparent hover:border-red-500 p-6 hover:shadow-lg transition">
          <div className="text-5xl mb-4">🎬</div>
